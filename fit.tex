...
The fit values of $C_1$ are plotted vs the Rayleigh and Schmidt numbers in \fref{C1VsParam}.
...
The fit values of $C_2$ are plotted vs the Rayleigh and Schmidt numbers in \fref{C2VsParam}.
...
The fit values of $C_3$ are plotted vs the Rayleigh and Schmidt numbers in \fref{C3VsParam}.
...
The fit values of $C_5$ are plotted vs the Rayleigh and Schmidt numbers in \fref{C5VsParam}.
...
The fit values of $C_7$ are plotted vs the Rayleigh and Schmidt numbers in \fref{C7VsParam}.
