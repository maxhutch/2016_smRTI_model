...
\begin{equation}
\int_0^d 1- \text{abs}\left[\phi_1(r)\right] dr = \frac{2 \delta}{\sqrt{\pi}} \left( 1 - \exp\left[-\frac{d^2}{\delta^2}\right]\right) + 2 d \left(1 - \erf\left[\frac{d}{\delta}\right]\right)
\end{equation}
...
\begin{equation}
S = \left( \lambda^2 + 4 C_5 \pi \lambda h\right)
\end{equation}
